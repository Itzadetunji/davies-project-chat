...
>(({ className, hasRight, children, truncate, ...props }, ref) => (
	...
	>
		...
		<SelectPrimitive.ItemText>
			<div className={`${truncate?.length ? truncate : ""}`}>
				{children}
			</div>
		</SelectPrimitive.ItemText>
		{!!hasRight && (
